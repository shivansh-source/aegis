...
const militaryDataByCountry: Record<string, MilitaryData> = {
  "US": {
    troops: {
      average: 1.3,
...
export const getCountryData = async (): Promise<Country[]> => {
  return [
...
export const getMilitaryData = (countryCode: string): MilitaryData | undefined => {
